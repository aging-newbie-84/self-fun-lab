...
const OnboardingScreen = ({ onComplete }) => {
    ...
    return (
        <div className={clsx(
            ...
            <div className="max-w-md w-full glass-panel rounded-3xl p-10 md:p-12 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col gap-4 mt-12 animate-fade-in" style={{ animationDelay: '0.8s', animationFillMode: 'both' }}>
                        <button
                            onClick={handleStart}
                        ...
                        <button
                            onClick={handleSkip}
                            className="w-full py-4 text-white/30 hover:text-white font-display tracking-[0.3em] uppercase text-[10px] transition-all duration-500"
                        >
                            Skip to discover
                        </button>
                    </div>
            ...
            {/* Bottom footnote */}
            <footer className="mt-8 relative z-10 animate-fade-in" style={{ animationDelay: '1s', animationFillMode: 'both' }}>
